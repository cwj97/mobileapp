...
btn1.addEventListener("click",
    function(){
        ...
        if(soundEndflag == "1"){
            ...
            let resulText = ["img/1.png","img/2.png","img/3.png","img/4.png","img/5.png",];
            ...
            let resultImage = ["img/6.png","img/7.png","img/8.png","img/9.png","img/10.png"];
            ...
            omikujiTextImage.src = resulText[n];
